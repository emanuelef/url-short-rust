...
def test_read_main():
    ...
    # Initialize app.state.index_html for testing
    app.state.index_html = "<html><body><h1>Test HTML</h1></body></html>"
...
def test_redirect():
    ...
    create_response = client.post(
        "/api/shorten", json={"url": "https://example.com/redirect-test"}
    )
