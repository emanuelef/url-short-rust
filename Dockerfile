...
COPY --from=builder-amd64 /app/target/x86_64-unknown-linux-musl/release/url-short-rust /app/url-short-rust-amd64
COPY --from=builder-arm64 /app/target/aarch64-unknown-linux-musl/release/url-short-rust /app/url-short-rust-arm64
